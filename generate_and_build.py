...
def run(config, prompts=None):
    ...
    try:
        ...
        from seo_optimizer import MidjourneySEOOptimizer
        ...
        optimizer = MidjourneySEOOptimizer(config)
    ...
    try:
        from site_generator import MidjourneySiteGenerator
        site_gen = MidjourneySiteGenerator(config)
        site_gen.build_site()
